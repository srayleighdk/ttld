...
class TrinhDoTinHocBloc extends Bloc<TrinhDoTinHocEvent, TrinhDoTinHocState> {
  ...
  TrinhDoTinHocBloc({required this.trinhDoTinHocRepository}) : super(TrinhDoTinHocInitial()) {
  ...
  Future<void> _onLoadTrinhDoTinHocs(LoadTrinhDoTinHocs event, Emitter<TrinhDoTinHocState> emit) async {
  ...
  Future<void> _onAddTrinhDoTinHoc(AddTrinhDoTinHoc event, Emitter<TrinhDoTinHocState> emit) async {
    try {
      final trinhDoTinHoc = await trinhDoTinHocRepository.addTrinhDoTinHoc(event.trinhDoTinHoc);
      if (state is TrinhDoTinHocLoaded) {
        final updatedTrinhDoTinHocs = List<TrinhDoTinHoc>.from((state as TrinhDoTinHocLoaded).trinhDoTinHocs)..add(trinhDoTinHoc);
  ...
  Future<void> _onUpdateTrinhDoTinHoc(UpdateTrinhDoTinHoc event, Emitter<TrinhDoTinHocState> emit) async {
    try {
