...
class NguonThuThapBloc extends Bloc<NguonThuThapEvent, NguonThuThapState> {
  ...
  NguonThuThapBloc({required this.nguonThuThapRepository}) : super(NguonThuThapInitial()) {
  ...
  Future<void> _onLoadNguonThuThaps(LoadNguonThuThaps event, Emitter<NguonThuThapState> emit) async {
  ...
  Future<void> _onAddNguonThuThap(AddNguonThuThap event, Emitter<NguonThuThapState> emit) async {
    try {
      final nguonThuThap = await nguonThuThapRepository.addNguonThuThap(event.nguonThuThap);
      if (state is NguonThuThapLoaded) {
        final updatedNguonThuThaps = List<NguonThuThap>.from((state as NguonThuThapLoaded).nguonThuThaps)..add(nguonThuThap);
  ...
  Future<void> _onUpdateNguonThuThap(UpdateNguonThuThap event, Emitter<NguonThuThapState> emit) async {
    try {
