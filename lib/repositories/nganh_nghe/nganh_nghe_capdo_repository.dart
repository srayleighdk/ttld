...
class NganhNgheCapDoRepositoryImpl implements NganhNgheCapDoRepository {
  ...
  @override
  Future<NganhNgheCapDo> addNganhNgheCapDo(NganhNgheCapDo nganhNgheCapDo) async {
    final response = await nganhNgheCapDoApiService.postNganhNgheCapDo(nganhNgheCapDo.toJson());
    return NganhNgheCapDo.fromJson(response.data['data'] as Map<String, dynamic>);
  }

  @override
  Future<NganhNgheCapDo> updateNganhNgheCapDo(NganhNgheCapDo nganhNgheCapDo) async {
    final response = await nganhNgheCapDoApiService.putNganhNgheCapDo(nganhNgheCapDo.toJson());
    return NganhNgheCapDo.fromJson(response.data['data'] as Map<String, dynamic>);
  }
