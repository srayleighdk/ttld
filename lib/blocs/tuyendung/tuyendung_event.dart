...
class TuyenDungEvent with _$TuyenDungEvent {
  ...
  const factory TuyenDungEvent.updateForm(NTDTuyenDung tuyenDung) = UpdateTuyenDungForm;
  const factory TuyenDungEvent.delete(String idTuyenDung, String? userId) = DeleteTuyenDung;
}
