...
import 'package:ttld/blocs/chuc_danh/chuc_danh_event.dart';
import 'package:ttld/blocs/chuc_danh/chuc_danh_state.dart';
import 'package:ttld/repositories/chuc_danh_repository.dart';

class ChucDanhBloc extends Bloc<ChucDanhEvent, ChucDanhState> {
  ChucDanhBloc({required this.chucDanhRepository})
      : super(const ChucDanhInitial()) {
